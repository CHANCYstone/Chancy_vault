...
上面是中国 2025 年的高高试卷，我希望你基于这个高考试卷为小学数学的教与学做一个方向上的指引，从小初高一体化的角度来看，你觉得这个高考试卷建议小学数学的教与学应该注意哪些方面。
...
- 优先使用英文搜索，优先采纳英文资料（因为互联网上英文资料在数量和质量上都是最好的），用中文撰写报告。

- 报告长度

- 请解读足够细致深入，长度尽可能长，上不封顶，一切以深入全面解读为基本目标。

- 参考资料

- 请参考Wikipedia、相关书籍、学术和科普期刊网站、权威媒体和杂志刊物的网站；

- 视觉化

- 请按需在研究报告中采用图表和可视化媒介，来辅助和促进理解；